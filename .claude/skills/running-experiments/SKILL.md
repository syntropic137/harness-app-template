...
3. Run the full verification (the monorepo's standard gate: `just build && just test && just lint` — these delegate to Turbo / Cargo / uv / Biome under the hood per `docs/standard/decisions/task-runner.md`) on the integrated branch.
