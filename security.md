...
- **Poisoned upstream sync.** A malicious or compromised lab → CHA
  ...
  with CODEOWNERS review (ADR `docs/standard/decisions/cha-sync-source-of-truth.md`),
...
The hooks slot (`docs/standard/decisions/hooks.md`) runs the diff-scope
...
Rationale + tool pick: see `docs/standard/decisions/secret-scanner.md`.
...
`docs/standard/decisions/hooks.md`).**
...
- [Gitleaks](https://github.com/gitleaks/gitleaks) — secret-scanner pick. See also `docs/standard/decisions/secret-scanner.md`.
- [Lefthook](https://github.com/evilmartians/lefthook) — hooks slot plugin. See also `docs/standard/decisions/hooks.md`.
...
`docs/standard/decisions/cha-sync-source-of-truth.md`) — never patched
