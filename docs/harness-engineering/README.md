...
| AI Agent Harnesses Explained: Architecture | BoringBot | <https://boringbot.substack.com/p/ai-agent-harnesses-explained-architecture> | [`references/boringbot-ai-agent-harnesses-architecture.md`](./references/boringbot-ai-agent-harnesses-architecture.md) |
