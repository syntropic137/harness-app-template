...
- A measured, opinionated default belt that ships with one plugin per slot — each pick research-backed, each pick documented in the numbered [ADR index](../adrs/).
...
- `binary-distribution-design.md` — the cargo-dist + cargo-binstall + local-fallback story (today: mostly in [`../adrs/ADR-0012-binary-distribution.md`](../adrs/ADR-0012-binary-distribution.md))
