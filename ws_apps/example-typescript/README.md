...
Per `docs/adrs/ADR-0004-telemetry-sdk.md`: Node SDK 0.218 defaults to HTTP/protobuf on port 4318. The template pins this default to avoid the cross-SDK transport mismatch gotcha (Rust/Python default to gRPC/4317).
